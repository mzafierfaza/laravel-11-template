<!-- <div class="main-sidebar" style="background-color: #004465;"> #B1FE35
  <aside id="sidebar-wrapper" style="background-color: #004465;"> -->
...
<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand">
      <a href="{{ url('') }}">
        <img style="max-width: 60%;" src="{{ asset(config('stisla.logo_kk')) }}"></a>
    </div>
