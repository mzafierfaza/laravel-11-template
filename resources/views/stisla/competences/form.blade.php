          ...
          <div class="card-body">
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
				...
				<div class="col-md-6">
                  @include('stisla.includes.forms.selects.select2', ['required'=>true, 'id'=>'level', 'name'=>'level', 'label'=>__('Level'), 'options'=>[{"label":"Pemula","value":"beginner"},{"label":"Menengah","value":"intermediate"},{"label":"Mahir","value":"advance"}], 'multiple'=>false])
                </div>
