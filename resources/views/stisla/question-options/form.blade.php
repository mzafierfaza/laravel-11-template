      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fa fa-list"></i> {{ $fullTitle }}</h4>
          </div>
          <div class="card-body">
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
				...
				<div class="col-md-6">
                  @include('stisla.includes.forms.editors.textarea', ['required'=>true, 'type'=>'textarea', 'id'=>'option_text', 'name'=>'option_text', 'label'=>__('Teks Pilihan')])
                </div>
