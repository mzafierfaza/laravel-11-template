                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="{{ config('app.url') }}" title="logo" target="_blank">
                                ...
                                <img width="60" src="{{ asset(config('stisla.logo_kk')) }}"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Tautan unik untuk membuat kata sandi Anda. Untuk mengatur ulang kata sandi Anda, Silahkan klik tombol dibawah
                                        </p>
                                        <a href="{{ $url }}"
