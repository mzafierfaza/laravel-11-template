    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              @include('stisla.includes.forms.inputs.input', ['required'=>true, 'type'=>'text', 'id'=>'firstname', 'name'=>'firstname', 'label'=>__('Nama Depan')])
            </div>

            <div class="col-md-6">
              @include('stisla.includes.forms.inputs.input', ['required'=>true, 'type'=>'text', 'id'=>'lastname', 'name'=>'lastname', 'label'=>__('Nama Belakang')])
            </div>
